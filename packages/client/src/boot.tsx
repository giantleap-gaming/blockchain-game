...
import { LoginScreen } from "./layers/react/components/LoginScreen";
...
function bootReact() {
  ...
  let wallet: any;
  try {
    const privateKey = sessionStorage.getItem("burnerWallet");
    wallet = new Wallet(privateKey || "");
  } catch (e) {
    console.log(e);
  }
  function renderEngine() {
    root.render(wallet?.address ? <Engine setLayers={setLayers} mountReact={mountReact} /> : <LoginScreen />);
  }
